...
/*   Updated: 2022/04/18 14:02:12 by kmilchev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		// {
// 			if (quotes_are_closed(string[vars->i]) 
//				 && string[vars->i] == symbol
// 					&& string[vars->i++ + 1] == symbol)
// 			{
...
// 		idx++;
// 	}
//	NOT SURE IF I NEED THIS. MAYBE I PUT IT BEFORE I HAD reset_quotes();
// 	// while (str[idx])    
// 	// {
